...
if  choice3.lower() == 'swear':
    choice4 = input("You had better get home and sort this out with your wife!")
if  choice2.lower() == 'boss':
    choice3 = input("Your boss tells you to go home and settle things with your wife") 
